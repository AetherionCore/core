...
namespace MapScripts.Map1
{
    public class NeutralMinionSpawn
    {
        ...
        public static void InitializeCamps()
        {
            ...
            //Baron
            var baron = CreateJungleCamp(new Vector3(4600.495f, 60.0f, 10250.462f), 12, TeamId.TEAM_UNKNOWN, "Baron", 1200f * 1000); //Spawn time increased to 20 minutes from 15 minutes (4.20)
